...
//==================================================================
const pages = {
  // @path canonical  JSON-LD count  bodyHTML
  'fenzhen': ['四型分诊图鉴 - 安柯耳 Airaquas', 'AI头皮健康媒体：分型检测、护理引导、知识科普。', '/fenzhen/', 5],
  'guide': ['头皮健康指南 - 安柯耳 Airaquas', '四步护理流程详解、常见问题、益生菌洗护科学原理。', '/guide/', 2],
  'research': ['头皮健康科研数据 - 安柯耳 Airaquas', 'KCNJ2、AI检测超99%、冷等离子体等前沿研究。', '/research/', 2],
  'sebderm': ['脂溢性皮炎头皮护理 - 安柯耳 Airaquas', '症状判断、日常护理、益生菌方案。油性+头痒的解决。', '/sebderm/', 2],
  'postpartum': ['产后脱发恢复指南 - 安柯耳 Airaquas', '产后脱发高峰期、恢复时间、护理方法。产后3-6月应对。', '/postpartum/', 1],
  'alopecia-areata': ['斑秃（鬼剃头）应对指南 - 安柯耳 Airaquas', '斑秃原因、能否自愈、治疗方法。突然圆形脱发应对。', '/alopecia-areata/', 1],
  'seasonal': ['季节性脱发应对指南 - 安柯耳 Airaquas', '季节性脱发原因、持续时间、应对。秋季掉发多怎么办？', '/seasonal/', 1],
  'dandruff': ['头皮屑真菌原因与护理 - 安柯耳 Airaquas', '马拉色菌、越洗越多原理、益生菌去屑方案。', '/dandruff/', 1],
  'folliculitis': ['头皮毛囊炎原因与护理 - 安柯耳 Airaquas', '头皮痘痘是毛囊炎吗？毛囊炎和普通痘痘区别护理。', '/folliculitis/', 1],
};

// Helper to generate a redirect page (SEO preserving)
function redirectPage(from, to) {
  return `<!DOCTYPE html><html><head><meta charset="UTF-8"/><title>${from}</title>
<link rel="canonical" href="https://airaquas.hair${to}"/>
<meta http-equiv="refresh" content="0;url=https://airaquas.hair${to}"/>
</head><body><p>Redirecting to <a href="https://airaquas.hair${to}">${to}</a></p></body></html>`;
}

//==================================================================
//  MAIN PAGES (registered routes match)
//==================================================================
...
const morePages = {
  'postpartum': page('产后脱发恢复指南 - 安柯耳 Airaquas', '产后脱发高峰期、恢复时间、护理。',
    '/postpartum/', [
      {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
        {"@type":"Question","name":"产后脱发什么时候开始？","acceptedAnswer":{"@type":"Answer","text":"产后2-4个月开始，激素骤降导致毛囊同步进入休止期。发生率约40-50%。"}},
        {"@type":"Question","name":"会持续多久？","acceptedAnswer":{"@type":"Answer","text":"一般2-6个月，6-9个月恢复。超过一年建议AI检测。"}},
        {"@type":"Question","name":"能预防吗？","acceptedAnswer":{"@type":"Answer","text":"正常生理过程，毛囊结构完好，90%可自愈。保持营养温和护理即可。"}},
        {"@type":"Question","name":"哺乳期能剃光头吗？","acceptedAnswer":{"@type":"Answer","text":"剃头不改变毛囊周期。温柔梳头有好处，剃头没必要。"}}]},
      {"@context":"https://schema.org","@type":"MedicalWebPage","about":{"@type":"MedicalCondition","name":"产后脱发","symptom":["大量掉发","发量减少"]}}
    ],
    `<div class="card"><span class="tag">FAQ</span><h3>产后脱发什么时候开始？</h3><p>产后2-4个月，发生率40-50%，大多6个月自行恢复。</p><div class="highlight">毛囊结构完好，90%可自愈。哺乳期不需要避讳。</div></div>
<div class="card"><span class="tag">FAQ</span><h3>会持续多久？</h3><p>一般2-6个月，多数6-9个月恢复。超过一年建议AI检测。</p></div>`),
  'alopecia-areata': page('斑秃（鬼剃头）应对指南 - 安柯耳 Airaquas', '斑秃原因、能否自愈、治疗方法。',
    '/alopecia-areata/', [
      {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
        {"@type":"Question","name":"斑秃是什么原因？","acceptedAnswer":{"@type":"Answer","text":"自身免疫攻击毛囊，60%患者发病前有重大压力。"}},
        {"@type":"Question","name":"能自愈吗？","acceptedAnswer":{"@type":"Answer","text":"50-60%轻度斑秃1年内自发恢复。单个斑块恢复率80%。"}},
        {"@type":"Question","name":"会复发吗？","acceptedAnswer":{"@type":"Answer","text":"30-50%会复发。避免压力、温和护理有助于管理。"}},
        {"@type":"Question","name":"和脂溢性皮炎区别？","acceptedAnswer":{"@type":"Answer","text":"机制完全不同。斑秃是免疫攻击，脂溢性皮炎是真菌。AI可区别。"}}]},
      {"@context":"https://schema.org","@type":"MedicalWebPage","about":{"@type":"MedicalCondition","name":"斑秃","symptom":["圆形脱发","突发性脱发"]}}
    ],
    `<div class="card"><span class="tag">FAQ</span><h3>斑秃原因？能自愈？</h3><p>免疫攻击毛囊。60%患者发病前有重大压力。50-60%轻度1年内恢复。</p><div class="highlight">斑秃和脂溢性皮炎机制完全不同。AI可区分。</div></div>
<div class="card"><span class="tag">FAQ</span><h3>会复发吗？区别？</h3><p>30-50%会复发。机制完全不同，AI检测可区分两种脱发。</p></div>`),
  'seasonal': page('季节性脱发应对指南 - 安柯耳 Airaquas', '季节性脱发原因、持续时间、应对。',
    '/seasonal/', [
      {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
        {"@type":"Question","name":"季节性脱发是真的吗？","acceptedAnswer":{"@type":"Answer","text":"真的。9-11月脱落最多。毛囊对光周期敏感，进化保留机制。"}},
        {"@type":"Question","name":"掉多少算正常？","acceptedAnswer":{"@type":"Answer","text":"比平时多30-40%正常（100-150根/天）。超200根/天或持续3个月建议AI检测。"}},
        {"@type":"Question","name":"秋季脱发严重怎么办？","acceptedAnswer":{"@type":"Answer","text":"温和清洁、正常营养、减少热造型。不要秋季开始强力防脱药物。"}},
        {"@type":"Question","name":"持续多久？","acceptedAnswer":{"@type":"Answer","text":"1-3个月，10-11月高峰后逐步恢复。"}}]},
      {"@context":"https://schema.org","@type":"MedicalWebPage","about":{"@type":"MedicalCondition","name":"季节性脱发"}}
    ],
    `<div class="card"><span class="tag">FAQ</span><h3>季节性脱发是真的吗？</h3><p>9-11月脱落最多。比平时多30-40%正常。</p><div class="highlight">超200根/天或持续3个月以上建议AI检测。</div></div>
<div class="card"><span class="tag">FAQ</span><h3>秋季怎么办？持续多久？</h3><p>温和清洁、正常营养、减少热造型。1-3个月恢复。</p></div>`),
  'dandruff': page('头皮屑真菌原因与护理 - 安柯耳 Airaquas', '马拉色菌、越洗越多原理、益生菌去屑。',
    '/dandruff/', [
      {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
        {"@type":"Question","name":"头皮屑是真菌引起？","acceptedAnswer":{"@type":"Answer","text":"马拉色菌分解皮脂产生游离脂肪酸加速角质脱落。益生菌不是杀菌而是微生态竞争，2-3周见效无抗药性。"}},
        {"@type":"Question","name":"为什么越洗越多？","acceptedAnswer":{"@type":"Answer","text":"每天强力去屑→屏障受损→马拉色菌更容易入侵。拉长间隔+益生菌洗发水。"}},
        {"@type":"Question","name":"头皮屑和脂溢性皮炎关系？","acceptedAnswer":{"@type":"Answer","text":"头皮屑是最早期表现。AI检测可评估是否已到就医阶段。"}}]},
      {"@context":"https://schema.org","@type":"MedicalWebPage","about":{"@type":"MedicalCondition","name":"头皮屑"}}
    ],
    `<div class="card"><span class="tag">FAQ</span><h3>头皮屑是真菌引起？</h3><p>马拉色菌。益生菌不是杀菌而是微生态竞争。</p><div class="highlight">益生菌去屑2-3周见效，温和无抗药性。</div></div>
<div class="card"><span class="tag">FAQ</span><h3>越洗越多？和脂溢性皮炎关系？</h3><p>每天强力去屑→屏障受损更严重。头皮屑是最早期表现。</p></div>`),
  'folliculitis': page('头皮毛囊炎原因与护理 - 安柯耳 Airaquas', '头皮痘痘是毛囊炎？毛囊炎护理方法。',
    '/folliculitis/', [
      {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
        {"@type":"Question","name":"头皮痘痘是毛囊炎？","acceptedAnswer":{"@type":"Answer","text":"发红有白头的痘痘大概率是毛囊炎（金葡菌感染）。伴随瘙痒或疼痛。"}},
        {"@type":"Question","name":"毛囊炎会脱发？","acceptedAnswer":{"@type":"Answer","text":"单次不会。反复发作损伤毛囊干细胞层可致永久脱发——瘢痕性脱发。"}},
        {"@type":"Question","name":"毛囊炎和脂溢性皮炎区别？","acceptedAnswer":{"@type":"Answer","text":"毛囊炎=单个毛囊细菌感染有脓头。脂溢性皮炎=真菌弥漫性炎症。AI可区分。"}}]},
      {"@context":"https://schema.org","@type":"MedicalWebPage","about":{"@type":"MedicalCondition","name":"毛囊炎"}}
    ],
    `<div class="card"><span class="tag">FAQ</span><h3>头皮痘痘是毛囊炎？</h3><p>发红有白头的痘痘大概率毛囊炎。细菌感染。</p><div class="highlight">反复发作可致毛囊闭锁→瘢痕性脱发。和脂溢性皮炎机制不同。</div></div>
<div class="card"><span class="tag">FAQ</span><h3>会脱发吗？和脂溢性皮炎区别？</h3><p>反复发作可致永久脱发。机制完全不同，AI可检测区分。</p></div>`),
};
...
// New pages (routes may need Cloudflare dashboard config)
app.get('/postpartum', (c) => c.html(morePages['postpartum']));
app.get('/postpartum/', (c) => c.html(morePages['postpartum']));
app.get('/alopecia-areata', (c) => c.html(morePages['alopecia-areata']));
app.get('/alopecia-areata/', (c) => c.html(morePages['alopecia-areata']));
app.get('/seasonal', (c) => c.html(morePages['seasonal']));
app.get('/seasonal/', (c) => c.html(morePages['seasonal']));
app.get('/dandruff', (c) => c.html(morePages['dandruff']));
app.get('/dandruff/', (c) => c.html(morePages['dandruff']));
app.get('/folliculitis', (c) => c.html(morePages['folliculitis']));
app.get('/folliculitis/', (c) => c.html(morePages['folliculitis']));

// Catch-all under /fenzhen/ — serves all pages at /fenzhen/SLUG
app.get('/fenzhen/:slug', (c) => {
  const slug = c.req.param('slug');
  const pageHtml = morePages[slug];
  if (pageHtml) return c.html(pageHtml);
  return c.html(sebDermHtml); // fallback
});
app.get('/fenzhen/:slug/', (c) => {
  const slug = c.req.param('slug');
  const pageHtml = morePages[slug];
...
app.get('/', (c) => c.json({ service: 'airaquas-public', version: '3.0.0' }));
export default app;
