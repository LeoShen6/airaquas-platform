...
// City listing page (SALON_HTML equivalent)
function genCityList() {
  var top = [['上海','sh',2184],['北京','bj',2193],['广州','gzhu',1955],['深圳','szhen',1524],['成都','cd',4020],['杭州','hz',2777],['武汉','wh',2899],['南京','nj',2323],['重庆','cq',3060],['西安','xa',2069],['哈尔滨','heb',2112]];
  var more = [['常州','cz',912],['苏州','su',1687],['天津','tj',1342],['沈阳','sy',1098],['厦门','xm',856],['郑州','zz',1456],['长沙','cs',1234]];
  ...
  return '<!DOCTYPE html><html lang="zh-CN"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1.0"/>'
    ...
    + '<div class="grp"><div class="grp-title">📍 更多城市</div><div class="city-wrap">' + tc(more) + '</div></div>'
    + '<a class="cta" href="/"><h3>AI 头皮检测 · 合作沙龙专属</h3><p>Tony 老师已入驻城市美发圈</p><div class="cta-btn">回到首页 →</div></a>'
    + '</div></body></html>';
}
...
export default {
  async fetch(request, env, ctx) {
    ...
    // API routes: 404 (Worker handles these separately)
